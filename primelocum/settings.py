"""
Django settings for primelocum project.
...
SECRET_KEY = 'django-insecure-7+rd6i6c5#xdngge=7wh^eol!qhn0xmi$dz3sbv6@kyg$*6q37'
...
WSGI_APPLICATION = 'primelocum.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR,'primelocum/static')
]
